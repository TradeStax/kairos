...
pub struct SavedState {
    ...
    pub ai_preferences: data::AiPreferences,
}
...
impl SavedState {
    pub fn window(&self) -> (iced::window::Position, iced::Size) {
        ...
        let size = self
            .main_window
            .as_ref()
            .map_or_else(crate::infra::window::default_size, |w| {
    ...
    pub fn default_with_service(
        ...
        SavedState {
            ...
            ai_preferences: data::AiPreferences::default(),
        }
    }
}
    ...
    match pane {
        ...
        data::Pane::Content {
            ...
            let content = match kind {
                ...
                data::ContentKind::CandlestickChart => pane::Content::Candlestick {
                    chart: None,
                    layout: data::ViewConfig::default(),
                    study_ids: vec![],
                },
                ...
                data::ContentKind::BacktestResult => pane::Content::Starter,
                // AiAssistant panes: restore the panel (conversation is empty on reload)
                data::ContentKind::AiAssistant => {
                    pane::Content::AiAssistant(
