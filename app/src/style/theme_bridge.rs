...
pub(crate) fn theme_to_iced(theme: &Theme) -> IcedTheme {
    ...
    match theme.id.as_str() {
        ...
        "catppuccino_latte" => IcedTheme::CatppuccinLatte,
        "catppuccino_frappe" => IcedTheme::CatppuccinFrappe,
        "catppuccino_macchiato" => IcedTheme::CatppuccinMacchiato,
        "catppuccino_mocha" => IcedTheme::CatppuccinMocha,
...
pub(crate) fn iced_theme_to_data(iced: IcedTheme) -> Theme {
    ...
    let (id, custom_palette) = match &iced {
        ...
        I::CatppuccinLatte => ("catppuccino_latte".to_string(), None),
        I::CatppuccinFrappe => ("catppuccino_frappe".to_string(), None),
        I::CatppuccinMacchiato => ("catppuccino_macchiato".to_string(), None),
        I::CatppuccinMocha => ("catppuccino_mocha".to_string(), None),
