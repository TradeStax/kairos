...
///
/// Distinct from `data::Side` (Buy/Sell) which represents
...
/// * `tick_step_units` - Tick size in price units (from PriceStep)
///
/// # Returns
...
/// ```ignore
/// use std::collections::BTreeMap;
/// use kairos::screen::dashboard::panel::domain::depth_grouping::{
///     group_depth_by_tick, DepthSide,
/// };
///
