...
impl PriceGrid {
    ...
    pub fn index_to_price(&self, idx: i32) -> Option<Price> {
        if idx == 0 {
            return None;
        }
        if idx > 0 {
...
pub struct TradeStore {
    trades: Vec<(u64, Price, f32, bool)>, // (time, price, qty, is_sell)
    grouped_buy: BTreeMap<Price, f32>,
    grouped_sell: BTreeMap<Price, f32>,
}
...
impl TradeStore {
    ...
    pub fn maybe_cleanup(&mut self, now_ms: u64, retention_ms: u64, step: PriceStep) -> bool {
