...
use data::util::serde as serde_defaults;
...
///
/// Mirrors `study::NodeDetectionMethod` but with a different default (`Relative`
/// here vs `Percentile` in the study crate). Existing serialized configs depend
/// on this default, so we keep the app-side enum and provide `From` conversions.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, Default)]
...
impl From<ProfileNodeDetectionMethod> for study::NodeDetectionMethod {
    fn from(v: ProfileNodeDetectionMethod) -> Self {
        match v {
            ProfileNodeDetectionMethod::Percentile => Self::Percentile,
            ProfileNodeDetectionMethod::Relative => Self::Relative,
            ProfileNodeDetectionMethod::StdDev => Self::StdDev,
        }
    }
}

impl From<study::NodeDetectionMethod> for ProfileNodeDetectionMethod {
    fn from(v: study::NodeDetectionMethod) -> Self {
        match v {
            study::NodeDetectionMethod::Percentile => Self::Percentile,
            study::NodeDetectionMethod::Relative => Self::Relative,
            study::NodeDetectionMethod::StdDev => Self::StdDev,
        }
    }
}
...
impl ProfileSplitUnit {
    pub const ALL: &'static [Self] = &[Self::Days, Self::Hours, Self::Minutes];
}
...
pub struct ProfileConfig {
    ...
    #[serde(default = "serde_defaults::default_split_value")]
    pub split_value: i64,
    #[serde(default = "serde_defaults::default_max_profiles")]
    pub max_profiles: i64,

    // Tick grouping
    #[serde(default = "serde_defaults::default_true")]
    pub auto_grouping: bool,
    #[serde(default = "serde_defaults::default_one")]
    pub auto_group_factor: i64,
    #[serde(default = "serde_defaults::default_one")]
    pub manual_ticks: i64,

    // Value Area
    #[serde(default = "serde_defaults::default_va_pct")]
    pub value_area_pct: f32,
    #[serde(default = "serde_defaults::default_true")]
    pub show_va_highlight: bool,
    pub vah_color: Option<data::Rgba>,
    pub val_color: Option<data::Rgba>,

    // Value Area (expanded)
    #[serde(default = "serde_defaults::default_true")]
    pub show_va_fill: bool,
    pub va_fill_color: Option<data::Rgba>,
    #[serde(default = "serde_defaults::default_va_fill_opacity")]
    pub va_fill_opacity: f32,
    #[serde(default = "serde_defaults::default_line_width")]
    ...
    #[serde(default = "serde_defaults::default_true")]
    pub show_poc: bool,
    pub poc_color: Option<data::Rgba>,
    #[serde(default = "serde_defaults::default_poc_width")]
    ...
    #[serde(default)]
    pub show_lvn: bool,
    #[serde(default = "serde_defaults::default_hvn_threshold")]
    pub hvn_threshold: f32,
    #[serde(default = "serde_defaults::default_lvn_threshold")]
    pub lvn_threshold: f32,
    pub hvn_color: Option<data::Rgba>,
    pub lvn_color: Option<data::Rgba>,
    ...
    pub hvn_zone_color: Option<data::Rgba>,
    #[serde(default = "serde_defaults::default_zone_opacity")]
    pub hvn_zone_opacity: f32,
    #[serde(default)]
    pub show_peak_line: bool,
    pub peak_color: Option<data::Rgba>,
    #[serde(default)]
    ...
    pub lvn_zone_color: Option<data::Rgba>,
    #[serde(default = "serde_defaults::default_zone_opacity")]
    pub lvn_zone_opacity: f32,
    #[serde(default)]
    pub show_valley_line: bool,
    pub valley_color: Option<data::Rgba>,
    #[serde(default)]
    ...
    // Colors
    pub volume_color: Option<data::Rgba>,
    pub bid_color: Option<data::Rgba>,
    pub ask_color: Option<data::Rgba>,
    #[serde(default = "serde_defaults::default_opacity")]
    pub opacity: f32,
