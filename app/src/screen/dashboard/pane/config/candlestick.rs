...
pub struct CandleStyle {
    pub bull_body_color: Option<data::Rgba>,
    pub bear_body_color: Option<data::Rgba>,
    pub bull_wick_color: Option<data::Rgba>,
    pub bear_wick_color: Option<data::Rgba>,
    pub bull_border_color: Option<data::Rgba>,
    pub bear_border_color: Option<data::Rgba>,
...
impl CandleStyle {
    ...
    pub fn get_color(&self, field: CandleColorField) -> Option<data::Rgba> {
        match field {
    ...
    pub fn set_color(&mut self, field: CandleColorField, color: Option<data::Rgba>) {
        match field {
