    ...
    S: SeriesLike,
{
    ...
    pub(super) fn fill_x_axis_labels(
        ...
        let (ticks, step_ms) =
            super::types::time_ticks(ctx.min_x, ctx.max_x, ctx.px_per_ms, MIN_X_TICK_PX);
        ...
        for t in ticks {
            ...
            let label = super::types::format_time_label(label_ts, step_ms);
    ...
    pub(super) fn fill_crosshair(
        ...
        let pct_str = super::types::format_pct(ci.y_pct, scene.y_step, true);
        let label_h = TEXT_SIZE + 6.0;
