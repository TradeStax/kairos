...
use crate::modals::{main_dialog_modal, positioned_overlay, settings};
        ...
        match menu {
            data::sidebar::Menu::Settings => {
                if let Some((page, body)) =
                    self.sidebar.settings.view_modal_body()
                {
                    ...
                    let on_save = Message::Sidebar(
                        dashboard::sidebar::Message::Settings(
                            settings::Message::SaveModal,
                        ),
                    );
                    let on_cancel = Message::Sidebar(
                        dashboard::sidebar::Message::Settings(
                            settings::Message::CloseModal,
                        ),
                    );
            ...
            data::sidebar::Menu::DataFeeds => {
                let data_feeds_content =
                    self.data_feeds_modal.view().map(Message::DataFeeds);
            ...
            data::sidebar::Menu::ThemeEditor => {
                ...
                positioned_overlay(
                    ...
                    self.theme_editor
                        .view(
                            &crate::style::theme_bridge::theme_to_iced(
                                &self.theme,
                            ),
                        )
