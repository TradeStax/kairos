...
impl IndicatorManagerModal {
    ...
    fn view_study_settings(
        ...
        if study_id == "big_trades" {
            ...
            header = header.push(
                space::horizontal().width(tokens::spacing::SM),
            );
        }
...
fn tab_default_label(tab: study::ParameterTab) -> &'static str {
    match tab {
        ...
        study::ParameterTab::Tab4 => "Tab 4",
        study::ParameterTab::Tab5 => "Tab 5",
        study::ParameterTab::Tab6 => "Tab 6",
        study::ParameterTab::Tab7 => "Tab 7",
    }
}
...
fn param_tab_to_settings_tab(
    ...
    match tab {
        ...
        study::ParameterTab::Tab4 => SettingsTab::Tab4,
        study::ParameterTab::Tab5 => SettingsTab::Tab5,
        study::ParameterTab::Tab6 => SettingsTab::Tab6,
        study::ParameterTab::Tab7 => SettingsTab::Tab7,
    }
}
...
fn settings_tab_to_param_tab(
    ...
    match tab {
        ...
        SettingsTab::Tab4 => study::ParameterTab::Tab4,
        SettingsTab::Tab5 => study::ParameterTab::Tab5,
        SettingsTab::Tab6 => study::ParameterTab::Tab6,
        SettingsTab::Tab7 => study::ParameterTab::Tab7,
    }
}
...
fn format_float(v: f32, fmt: study::DisplayFormat) -> String {
    match fmt {
