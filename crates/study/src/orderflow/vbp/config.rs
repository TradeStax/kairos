...
impl VbpStudy {
    ...
    pub(super) fn parse_node_method(
        s: &str,
    ) -> NodeDetectionMethod {
        match s {
    ...
    pub(super) fn build_poc_config(&self) -> VbpPocConfig {
        VbpPocConfig {
            ...
            poc_line_width: self
                ...
                as f32,
            poc_line_style: self.config.get_line_style(
                "poc_line_style",
    ...
    pub(super) fn build_va_config(
        ...
        VbpValueAreaConfig {
            ...
            vah_line_width: self
                ...
                as f32,
            vah_line_style: self.config.get_line_style(
                "va_vah_line_style",
                LineStyleValue::Dashed,
            ),
            val_color: self
            ...
            val_line_width: self
                ...
                as f32,
            val_line_style: self.config.get_line_style(
                "va_val_line_style",
                LineStyleValue::Dashed,
            ),
            show_va_fill: self
            ...
            va_fill_color: self.config.get_color(
                "va_fill_color",
                DEFAULT_VA_FILL_COLOR,
            ),
    ...
    pub(super) fn build_node_config(&self) -> VbpNodeConfig {
        VbpNodeConfig {
            ...
            peak_line_style: self.config.get_line_style(
                "peak_line_style",
                LineStyleValue::Solid,
            ),
            ...
            valley_color: self.config.get_color(
                "valley_color",
                DEFAULT_VALLEY_COLOR,
            ),
            valley_line_style: self.config.get_line_style(
                "valley_line_style",
                LineStyleValue::Solid,
            ),
    ...
    pub(super) fn build_vwap_config(&self) -> VbpVwapConfig {
        VbpVwapConfig {
            ...
            vwap_line_width: self
                ...
                as f32,
            vwap_line_style: self.config.get_line_style(
                "vwap_line_style",
                LineStyleValue::Solid,
            ),
            ...
            band_line_style: self.config.get_line_style(
