...
use crate::output::{
    ...
    FootprintData, FootprintGroupingMode, FootprintLevel,
    FootprintRenderMode, FootprintScaling, FootprintDataType,
    OutsideBarStyle, StudyOutput, TextFormat,
};
use data::{SerializableColor, Side, Trade};
