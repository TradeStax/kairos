    ...
    impl HistAgg {
        ...
        pub fn values_for(&self, ratio: StackedBarRatio) -> Option<(f64, f64, f32)> {
            let (buy_val, sell_val) = match ratio {
                StackedBarRatio::Count => (self.buy_count as f64, self.sell_count as f64),
                StackedBarRatio::Volume => (self.buy_volume as f64, self.sell_volume as f64),
                StackedBarRatio::AverageSize => {
