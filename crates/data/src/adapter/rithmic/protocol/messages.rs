//! Rithmic protocol message enum.
//!
//! [`RithmicMessage`] is the unified enum covering all protobuf message
//! types received from Rithmic plants, plus synthetic variants for
//! connection errors and heartbeat timeouts.
...
/// Unified enum for all Rithmic protobuf message types and synthetic events.
///
/// Market data variants (e.g. `LastTrade`, `BestBidOffer`, `OrderBook`)
/// carry real-time updates. Response variants carry request-response data.
/// `ConnectionError`, `HeartbeatTimeout`, and `Unknown` are synthetic
/// variants generated by the adapter, not by Rithmic servers.
