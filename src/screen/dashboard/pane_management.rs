...
impl Dashboard {
    ...
    pub(super) fn popout_pane(&mut self, main_window: &Window) -> Task<Message> {
    ...
    pub(super) fn merge_pane(&mut self, main_window: &Window) -> Task<Message> {
    ...
    pub(super) fn iter_all_panes_mut(
        &mut self,
        main_window: window::Id,
