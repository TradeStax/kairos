...
//!
//! Tracks rendering performance metrics and enforces budgets to maintain 60 FPS.
//!
//! ## Key Metrics
//! - **Draw Calls**: Number of individual render operations (circles, rectangles, lines)
//! - **Vertices**: Total number of vertices rendered
//! - **Frame Time**: Time taken to render (target: < 16.67ms for 60 FPS)
//!
//! ## Budget Enforcement
//! - Max draw calls per frame: 50,000
//! - Max vertices per frame: 200,000
//! - Auto-quality adjustment when over budget
...
impl QualityAdjustment {
    ...
    pub fn adjust_lod(&self, current: super::lod::LodLevel) -> super::lod::LodLevel {
