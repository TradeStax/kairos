//! Performance Systems
//!
//! This module provides performance monitoring, level-of-detail (LOD) rendering,
//! viewport culling, progressive rendering, and instrument-specific presets.
//!
//! ## Submodules
//! - `lod`: Level-of-detail system for dynamic quality adjustment
//! - `viewport`: Viewport bounds and culling for off-screen elements
//! - `progressive`: Progressive rendering with phase-based time budgets
//! - `presets`: Performance presets for different instrument types
//! - `overlay`: Debug overlay for real-time performance metrics
