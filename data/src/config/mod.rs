//! Configuration types and utilities for application settings
//!
//! This module provides strongly-typed configuration structures for various
//! application settings including theme, timezone, sidebar preferences, and
//! UI scaling factors.
